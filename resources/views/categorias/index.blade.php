                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                                    <label for="filterInput" class="form-label">Grupo</label>
                                                ...
                                                <!-- Botões -->
                                                <div class="col-12 col-sm-4 col-md-4 col-lg-3 col-xl-3" style="margin-top:30px;">
...
<script>
    ...
    function loadItems(url = "{{ route('app.categorias.getItens') }}") {
    ...
    $(document).on('change', '.toggle-status', function(e) {
        ...
        var url = "{{ route('app.categorias.toggleStatus', ':id') }}".replace(':id', categoriaId);
    ...
    $(document).on('click', '.btn-destroy', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var url = "{{ route('app.categorias.destroy', ':id') }}".replace(':id', categoriaId);
