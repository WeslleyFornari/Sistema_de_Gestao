        ...
        <div class="card">
            ...
            <div class="row mb-3">
                    ...
                    <div class="actions-btn">
                                ...
                                <a href="{{ route('app.usuarios.create') }}" class="btn btn-primary">
...
<script>
    ...
    function loadItems(url = "{{ route('app.usuarios.getItens') }}") {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Sucesso',
                    text: 'Usuarios carregados com sucesso',
                    toast: true,
                    position: 'top-end',
                    timer: 3000,
    ...
    $(document).on('change', '.toggle-status', function(e) {
        ...
        var url = "{{ route('app.usuarios.toggleStatus', ':id') }}".replace(':id', userId);
    ...
    $(document).on('click', '.btn-destroy', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var url = "{{ route('app.usuarios.destroy', ':id') }}".replace(':id', userId);
