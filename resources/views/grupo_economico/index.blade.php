        ...
        <div class="card">
            ...
            <div class="row mb-3">
                    ...
                    <div class="actions-btn">
                                ...
                                <a href="{{ route('app.grupo_economico.create') }}" class="btn btn-primary">
...
<script>
    ...
    function loadItems(url = "{{ route('app.grupo_economico.getItens') }}") {
    ...
    $(document).on('click', '.btn-destroy', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var url = "{{ route('app.grupo_economico.destroy', ':id') }}".replace(':id', userId);
