<div class="row d-flex border-bottom py-2 mb-2">
    <div class="col-4 col-sm-4 font-weight-bolder opacity-7 text-xs">Nome</div>
    <div class="col-4 col-sm-4 font-weight-bolder opacity-7 text-xs">Grupo Econômico</div>
...
<div class="row border-bottom py-1" style="font-size: 14px;">
    <div class="col-4 col-sm-4">{{ $value->nome ?? '' }}</div>
    <div class="col-4 col-sm-4">{{ $value->grupo->nome ?? '' }}</div>
    ...
    <div class="col-4 col-sm-1">
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                <li>
                    <a class="dropdown-item editar-usuarios" href="{{ route('app.bandeiras.edit', $value->id) }}">
                        Editar
                    </a>
                </li>
                <li>
                    <a class="dropdown-item btn-destroy" href="{{ route('app.bandeiras.destroy', $value->id) }}" data-id="{{ $value->id }}">
                        Excluir
                    </a>
                </li>
            </ul>
...
<div id="pagination-links" class="mt-3 w-100">
    <nav class="d-flex flex-wrap justify-content-center">
        {{ $bandeiras->links('pagination::bootstrap-4') }}
    </nav>
</div>