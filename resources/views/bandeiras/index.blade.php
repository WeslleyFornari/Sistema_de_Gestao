        ...
        <div class="card">
            ...
            <div class="row mb-3">
                    ...
                    <div class="actions-btn">
                                ...
                                <a href="{{ route('app.bandeiras.create') }}" class="btn btn-primary">
...
<script>
    ...
    function loadItems(url = "{{ route('app.bandeiras.getItens') }}") {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Sucesso',
                    text: 'Bandeiras carregadas com sucesso',
                    toast: true,
                    position: 'top-end',
                    timer: 3000,
            ...
            error: function() {
                Swal.fire({
                    icon: 'error',
                    title: 'Erro',
                    text: 'Erro ao carregar a lista de Bandeiras.',
                    toast: true,
                    position: 'top-end',
                    timer: 3000,
                    showConfirmButton: false
    ...
    $(document).on('click', '.btn-destroy', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var url = "{{ route('app.bandeiras.destroy', ':id') }}".replace(':id', bandeiraId);
