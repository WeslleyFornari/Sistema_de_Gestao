...
@section('scripts')
        ...
        <script>
            ...
            function loadItems(url = "{{ route('app.fluxo-caixa.contas-receber.getItens') }}") {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Sucesso',
                            text: 'Contas a receber carregadas com sucesso',
                            toast: true,
                            position: 'top-end',
                            timer: 3000,
                    ...
                    error: function() {
                        Swal.fire({
                            icon: 'error',
                            title: 'Erro',
                            text: 'Erro ao carregar a lista de contas a receber.',
                            toast: true,
                            position: 'top-end',
                            timer: 3000,
                            showConfirmButton: false
            ...
            $('#btnAddLancamento').click(function() {
                const url = "{{ route('app.fluxo-caixa.contas-receber.create') }}";
            ...
            $(document).on('click', '.btnEditItem', function(e) {
                ...
                let url = "{{ route('app.fluxo-caixa.contas-receber.edit', ['id' => '__id__']) }}";
            ...
            $(document).on('click', '.toggle-payment', function(e) {
                ...
                const lancamentoId = $(this).data('id');
                let url = "{{ route('app.fluxo-caixa.contas-receber.togglePayment', ':id') }}".replace(':id', lancamentoId);
            ...
            $(document).on('change', '.toggle-status', function(e) {
                ...
                var url = "{{ route('app.fluxo-caixa.contas-receber.toggleStatus', ':id') }}".replace(':id', contaId);
